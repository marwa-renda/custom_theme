...
function marwa_css_js_file_calling(){
  wp_enqueue_style('marwa-style', get_stylesheet_uri());
...
add_action('wp_enqueue_scripts', 'marwa_css_js_file_calling');


// Google Fonts Enqueue
function marwa_add_google_fonts(){
  wp_enqueue_style('marwa_google_fonts', 'https://fonts.googleapis.com/css2?family=Oswald&family=Roboto:wght@400;700&display=swap', false);
}
add_action('wp_enqueue_scripts', 'marwa_add_google_fonts');
